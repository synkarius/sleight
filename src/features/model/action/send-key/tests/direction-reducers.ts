...
//     const actual1 = actionReduxReducer(preReducerState1, validateDirection());
...
//     const actual2 = actionReduxReducer(preReducerState2, validateDirection());
...
//     const actual = actionReduxReducer(preReducerState, validateDirection());
...
//     const actual = actionReduxReducer(preReducerState, resetDirection());
